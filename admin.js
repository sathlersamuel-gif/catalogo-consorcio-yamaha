  ...
  function renderLogin() {
    root.innerHTML = `<main class="login-page">
      ...
      <section class="card login-card">
        ...
        <form id="loginForm">
          <label class="field"><span>PIN / senha</span><input name="password" type="password" minlength="6" autocomplete="current-password" inputmode="numeric" placeholder="Digite sua senha" required></label>
    ...
    return `${pageHeader('DADOS DO VENDEDOR E ACESSO', 'Configurações')}
      <form id="settingsForm" class="card settings-card">
        <div class="form-grid">
          ...
          <label class="field full"><span>Novo PIN / senha</span><input name="password" type="password" minlength="6" autocomplete="new-password" inputmode="numeric" placeholder="Deixe vazio para não alterar"><small>Use pelo menos 6 caracteres. Não use sequências fáceis.</small></label>
        </div>
